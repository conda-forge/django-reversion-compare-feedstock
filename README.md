About django-reversion-compare-feedstock
========================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/django-reversion-compare-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/jedie/django-reversion-compare
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3854&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-reversion-compare-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-reversion-compare` can be installed with `conda`:
...
```
mamba install django-reversion-compare
```

It is possible to list all of the versions of `django-reversion-compare` available on your platform with `conda`:
...
```
mamba search django-reversion-compare --channel conda-forge
```
...
mamba repoquery search django-reversion-compare --channel conda-forge

# List packages depending on `django-reversion-compare`:
mamba repoquery whoneeds django-reversion-compare --channel conda-forge

# List dependencies of `django-reversion-compare`:
mamba repoquery depends django-reversion-compare --channel conda-forge
```
